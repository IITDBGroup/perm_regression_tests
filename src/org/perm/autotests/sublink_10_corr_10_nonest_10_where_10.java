...
public class sublink_10_corr_10_nonest_10_where_10 extends AbstractPermTester {

	public sublink_10_corr_10_nonest_10_where_10 (String name) {
		super (name);
	}
	
	@Test
    public void testSetFile () throws SQLException, Exception {
		setGenerator("sublink.corr.nonest.where");
