...
public class sublink_10_uncorr_10_nonest_10_target_10 extends AbstractPermTester {

	public sublink_10_uncorr_10_nonest_10_target_10 (String name) {
		super (name);
	}
	
	@Test
    public void testSetFile () throws SQLException, Exception {
		setGenerator("sublink.uncorr.nonest.target");
